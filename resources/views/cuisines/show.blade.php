...
@section('content')
    <div class="container mx-auto p-4">
        <!-- Header Back Button -->
        <div class="mb-4">
            <a href="{{ route('cuisines.index') }}" class="text-yellow-500 hover:text-yellow-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <img src="{{ asset('img/' . $cuisine->image) }}" alt="Thumbnail 3"
            ...
            <div class="mt-6 flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex flex-col space-y-2 text-center md:text-left">
                    ...
                    <div class="flex items-center">
                        ...
                        <span>Buka
                            {{ \Carbon\Carbon::createFromFormat('H:i:s', $cuisine->opening_hours)->format('H:i') }} -
                            {{ \Carbon\Carbon::createFromFormat('H:i:s', $cuisine->closing_hours)->format('H:i') }}
                            WIB</span>
                    </div>
                    <div class="flex items-center">
