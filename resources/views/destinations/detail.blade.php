        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-10">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <img src="{{ Storage::url($destination->image) }}" alt="Thumbnail 3"
            ...
            <div class="mt-8 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div class="flex flex-wrap gap-2 mt-4 md:mt-0">
                    <a href="#" class="bg-yellow-400 text-blue-900 px-4 py-2 rounded-lg hover:bg-blue-700 hover:text-yellow-200 flex items-center space-x-2 font-semibold shadow transition"><i class="fas fa-map"></i><span>Rute</span></a>
                    <a href="#" class="bg-yellow-400 text-blue-900 px-4 py-2 rounded-lg hover:bg-blue-700 hover:text-yellow-200 flex items-center space-x-2 font-semibold shadow transition"><i class="fas fa-phone"></i><span>Kontak</span></a>
                    <a href="#" class="bg-yellow-400 text-blue-900 px-4 py-2 rounded-lg hover:bg-blue-700 hover:text-yellow-200 flex items-center space-x-2 font-semibold shadow transition"><i class="fas fa-bookmark"></i><span>Simpan</span></a>
