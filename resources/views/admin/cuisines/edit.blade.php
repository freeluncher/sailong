    ...
    <div class="h-screen">
        <div class="container mx-auto p-4">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-3xl font-bold">Edit Cuisine</h1>
                <a href="{{ route('admin.cuisines.index') }}" class="text-blue-500 hover:underline">Back to List</a>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="mb-4">
                        ...
                        <div id="action_buttons_container">
                            @foreach ($cuisine->action_buttons as $index => $button)
