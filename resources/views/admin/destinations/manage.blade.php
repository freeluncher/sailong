    ...
    <div class="min-h-screen bg-blue-50">
        <div class="container mx-auto py-8 px-4">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-3xl font-bold text-blue-800">Destinations</h1>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-x-auto">
                <table class="min-w-full divide-y divide-blue-100">
                    <thead class="bg-blue-100">
                        <tr>
                            <th
                                class="py-3 px-6 text-left text-xs font-bold text-blue-700 uppercase tracking-wider">
                                Name
                            </th>
                            <th
                                class="py-3 px-6 text-left text-xs font-bold text-blue-700 uppercase tracking-wider">
                            ...
                            <th
                                class="py-3 px-6 text-center text-xs font-bold text-blue-700 uppercase tracking-wider">
                                Actions
                            </th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-blue-50">
                        @foreach ($destinations as $destination)
                            <tr class="hover:bg-blue-50 transition">
                                ...
                                <td class="py-3 px-6">{{ 'Rp ' . number_format($destination->ticket_price, 0, ',', '.') }}
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <a href="{{ route('admin.destinations.edit', $destination->id) }}"
                                        class="inline-flex items-center gap-1 text-blue-600 hover:text-blue-800 font-medium px-3 py-1 rounded transition">
                                    ...
                                    <form action="{{ route('admin.destinations.destroy', $destination->id) }}"
                                        ...
                                        <button type="submit" onclick="return confirm('Are you sure?')"
                                            class="inline-flex items-center gap-1 text-red-600 hover:text-red-800 font-medium px-3 py-1 rounded transition">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
